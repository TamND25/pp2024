...
def main(stdscr):
    ...
    """)
        ...
        if option == '0':
            ...
            input_students_information(stdscr, student_list, "students.dat")
        elif option == '4':
            input_courses_information(stdscr, course_list, "students.dat")
        elif option == '5':
            add_mark(stdscr, student_list, course_list, "students.dat")
        elif option == '6':
